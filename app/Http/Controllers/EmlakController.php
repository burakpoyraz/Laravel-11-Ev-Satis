...
class EmlakController extends Controller
{
    ...
    public function index()
    {
        ...
        $emlaks = Emlak::where("userid", Auth::id())->get();



        return view('home.user_ilan', compact('emlaks'));
    }
    ...
    public function create()
    {
        ...
        return view('home.user_ilan_add', ['categories' => $categories, "iller" => $this->iller, "isinma_tipleri" => $this->isinma_tipleri]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('homeemlaks');
    ...
    public function edit(Emlak $emlak, $id)
    {
        ...
        return view("home.user_ilan_edit", ["emlak" => $emlak, "ozellik" => $ozellik, "categories" => $categories, "iller" => $this->iller, "isinma_tipleri" => $this->isinma_tipleri]);
