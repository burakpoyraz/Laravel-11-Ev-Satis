                ...
                <div id="carousel-example" class="carousel slide" data-ride="carousel" style="border: 5px solid #000;">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            ...
                            <img src="{{asset("assets/admin")}}/assets/img/slideshow/1.jpg" alt="" />

                        </div>
                        <div class="item">
                            <img src="{{asset("assets/admin")}}/assets/img/slideshow/2.jpg" alt="" />

                        </div>
                        <div class="item">
                            <img src="{{asset("assets/admin")}}/assets/img/slideshow/3.jpg" alt="" />
                            ...
                            <div class="media-body">
                                ...
                                <div class="media">
                                    <a class="pull-left" href="#">
                                        <img class="media-object img-circle img-comments" src="{{asset("assets/admin")}}/assets/img/user.png" />
                                    </a>
                                    <div class="media-body">
                                        ...
                                        <div class="media">
                                            <a class="pull-left" href="#">
                                                <img class="media-object img-circle img-comments" src="{{asset("assets/admin")}}/assets/img/user.gif" />
                                            </a>
                                            <div class="media-body">
